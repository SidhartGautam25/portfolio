...
const Left: React.FC<OutputProps> = ({ content }) => {
  return (
    <div className="bg-gray-900 text-white h-screen flex flex-col justify-between font-mono overflow-hidden">
      ...
      <div className="bg-gray text-green-500 p-4 border-t border-gray-700 font-mono">
        <p className="mb-2">Available commands:</p>
        <ul className="pl-4">
          <li className="mb-1">
            <span className="text-cyan-400">navneet show projects</span>:{" "}
            Display the projects section
          </li>
          <li className="mb-1">
            <span className="text-cyan-400">navneet show experience</span>:{" "}
            Display the experience section
          </li>
          <li className="mb-1">
            <span className="text-cyan-400">navneet show skills</span>: Display
            the skills section
          </li>
          <li>
            <span className="text-cyan-400">help</span>: Show all available
            commands
          </li>
        </ul>
      </div>
